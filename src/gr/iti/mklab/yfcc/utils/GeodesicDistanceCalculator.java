...
public class GeodesicDistanceCalculator {
	...
	public static Double vincentyDistance(Point p1, Point p2) {
		return vincentyDistance(p1.getLatitude(), p1.getLongitude(),
...
private static Map<Integer, Double> degreeToKilometersMap;
	...
	public static void main(String...args) {
		Point p1 = new Point(22.944419, 40.640063);	// Thessaloniki
		Point p2 = new Point(23.729360, 37.983917);	// Athens
		
		Double distance =  vincentyDistance(p1, p2);
